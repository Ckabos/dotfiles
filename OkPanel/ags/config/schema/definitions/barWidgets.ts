...
export enum BarWidget {
    ...
    IP_INDICATOR = "ipIndicator", // <-- WIDGET AÑADIDO
    LOCK = "lock",
    LOGOUT = "logout",
    MENU = "menu",
    ...
    PORT_MONITOR= "portMonitor", // <-- WIDGET AÑADIDO
    POWER_PROFILE = "powerProfile",
    RECORDING_INDICATOR = "recordingIndicator",
    RESTART = "restart",
    SCREENSHOT = "screenshot",
    SHUTDOWN = "shutdown",
    SWAP_WORKSPACE = "swapWorkspace",
...
export const barWidgetsSchema = {
    ...
    children: [
        ...
        {
            name: BarWidget.IP_INDICATOR,  // <-- ESQUEMA AÑADIDO
            type: "object",
            description: "Configuration for the IP indicator bar widget.",
            children: [...widgetCommons()],
        },
	{
            name: BarWidget.PORT_MONITOR,
            type: "object",
            description: "Configuration for the active port monitor widget.",
            children: [...widgetCommons()],
        },
        {
            name: BarWidget.LOCK,
        ...
        },
        {
            ...
            name: BarWidget.NET_TRAFFIC,
            type: "object",
            description: "Configuration for the net traffic bar widget.",
            children: [...widgetCommons()],
        },
        {
        ...
        {
            name: BarWidget.SWAP_WORKSPACE,
            type: "object",
            description: "Configuration for the swap workspace to other monitor widget.",
            children: [...widgetCommons()],
        },
	{
            name: BarWidget.TARGET_TRACKER,
            type: "object",
            description: "Configuration for the Target Tracker widget.",
            children: [...widgetCommons()],
        },
        {
