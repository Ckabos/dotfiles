...
export const soundsSchema = {
    ...
    children: [
        ...
        },
        {
            ...
            type: 'boolean',
            description: 'Whether or not to play a sound when a new notification arrives',
            default: 'true'
        },
        {
            name: 'notificationSoundPath',
            type: 'string',
            description: 'Full path to a sound file that will be played when a new notification arrives. No bundled default; required for the sound to play.',
            default: ''
        },
        {
            name: 'criticalNotificationSoundPath',
            type: 'string',
            description: 'Full path to a sound file played instead of the normal one when the notification urgency is CRITICAL. If empty, the normal notification sound is used.',
            default: ''
        },
        {
            name: 'mutedNotificationApps',
            type: 'string',
            description: 'Comma-separated list of app names whose notifications should NOT play a sound (case-insensitive, matched against the notification app name).',
            default: ''
        }
    ]
