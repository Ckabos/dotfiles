...
cp $HOME/Varda-Theme/setup/installFiles/portals.conf $HOME/.config/xdg-desktop-portal/
...
sudo cp $HOME/Varda-Theme/setup/installFiles/yazi-kitty.sh /usr/local/bin/
sudo cp $HOME/Varda-Theme/setup/installFiles/yazi-kitty.desktop /usr/share/applications/
