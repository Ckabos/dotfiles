...
// =====================================================================
// CUSTOM CAVA ENGINE (Blindado contra Deadlocks)
// =====================================================================
class CustomCava {
    ...
    private start() {
        try {
            ...
            const readLoop = () => {
                if (!this.stream || this.cancellable.is_cancelled()) return;

                this.stream.read_line_async(0, this.cancellable, (s, res) => {
                    try {
                        ...
                        // Validación agnóstica del idioma
